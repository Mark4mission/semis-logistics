...
(() => {
  ...
  const SYNC_KEYS = ["menus", "notices", "schedules", "assignees", "assigneesSeeded", "minutes", "minuteFolders", "levelHistory", "safetyBoard", "contacts", "pwOverrides", "userOverrides", "customUsers", "gcal", "chatRooms", "vault", "regulations"];
